...
const Login: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-[#1A2026] to-[#872816] p-4 md:p-12">
        <div className="w-full md:w-1/2 flex items-center justify-center mb-6 md:mb-0 bg-[#1A2026]">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center">
          <div className="bg-[#872816] p-6 md:p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <div className="mt-4 text-center">
              <Link href="/forgot-password" className="text-sm text-white hover:text-[#C4710B] hover:underline">
                Forgot Password?
              </Link>
            </div>
          </div>
