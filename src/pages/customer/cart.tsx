    ...
    <CustomerLayout title="Home">
      {loading ? (
        <div className="flex justify-center items-center h-64">
          <div className="w-12 h-12 border-4 border-[#b9c6c8] border-t-transparent rounded-full animate-spin"></div>
          <p className="mt-4 text-[#1d2c36] font-medium italic">Loading delicious options near you...</p>
        </div>
      ) : (
        <div className="pb-10">
          {/* Hero Carousel */}
          ...
          {profile?.loyalty_points >= 5 && (
            <div className="container mx-auto px-4 mt-4">
              <div className="bg-gradient-to-r from-[#b9c6c8]/20 to-[#8f8578]/20 border border-[#b9c6c8] rounded-lg p-4 mb-6 flex items-center justify-between">
                <div className="flex items-center">
                  <div className="bg-gradient-to-r from-[#b9c6c8] to-[#1d2c36] p-2 rounded-full mr-3">
                    <Heart className="h-5 w-5 text-[#8f8578]" />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#b9c6c8] to-[#1d2c36] text-[#8f8578] px-4 py-2 rounded-lg text-sm font-medium hover:from-[#1d2c36] hover:to-[#b9c6c8] transition-all duration-300"
                >
                  Order Now
                </button>
              </div>
          ...
          <div className="container mx-auto px-4 mt-8">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-[#1d2c36]">Explore Our Options</h2>
