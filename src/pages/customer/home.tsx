        ...
        <div className="pb-10">
          ...
          {profile?.loyalty_points >= 5 && (
            <div className="container mx-auto px-4 mt-4">
              <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-4 mb-6 flex items-center justify-between">
                <div className="flex items-center">
                  <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-2 rounded-full mr-3">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#b9c6c8] to-[#a8b5b8] text-[#1d2c36] px-4 py-2 rounded-lg text-sm font-medium hover:from-[#a8b5b8] hover:to-[#97a4a7] transition-all duration-300"
                >
                  Order Now
                </button>
              </div>
